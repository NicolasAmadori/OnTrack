<template>
  ...
  <div class="mx-2 flex flex-col">
    <form @submit.prevent="submitForm" class="flex flex-col">
      ...
      <BaseInput id="name" v-model="form.name" type="text" placeholder="Name" required />
      <BaseInput id="surname" v-model="form.surname" type="text" placeholder="Surname" required />
      <BaseInput id="password" v-model="form.password" type="password" placeholder="Password" :minlength="password_min_length" required />
      <BaseInput id="confirmpassword" v-model="form.confirmpassword" type="password" placeholder="Confirm Password" :minlength="password_min_length" required />
